...
el resultado de tal evaluaci\'on deber\'ia $4$ si nos basamos en la sem\'antica operacional.
...
entonces implica que la frase $\clambda{\iota}{\intt}{\clambda{\iota}{\intt} \ \iota \times \iota}$
...
\begin{definition}{lambdaa:typescategory}
...
\indent
$f_{\circledcirc} = (\lambda x . \ (\lambda x' . \ \iotabot \ (f \ x \ x'))_{\dbot})_{\dbot}$\\
...
$\semBrcks{\pi \vdash \neg e : \boolt}$ $=$ $-_{\odot} \circ \semBrcks{\pi \vdash e : \boolt}$\\
...
\item An\'alogo para todos los dem\'as operadores binarios, un\'arios, para
la expresi\'on condicional, la aplicaci\'on y el operador de punto fijo.\\
...
para poder aplicar la hip\'otesis inductiva debemos probar\\
