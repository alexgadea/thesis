...
$\semBrcks{ \pi \vdash \cifthenelse{b}{e}{e'}: \theta}C \ \eta$ 
$C_0 \ z_0 \ \ldots \ C_n \ z_n \ \sigma$ $=$ \\
\indent \indent \indent \ \
$(\lambda b . \ if \ b $ $
	then \ \semBrcks{ \pi \vdash e : \theta}C \ \eta \ C_0 \ z_0 \ \ldots \ C_n \ z_n \ \sigma$\\
	\indent \indent \indent \indent \indent \ \ \ \ \ \
	$else \ \semBrcks{ \pi \vdash e' : \theta}C \ \eta \ C_0 \ z_0 \ \ldots \ C_n \ z_n \ \sigma)_{\dbot}$ \\
	\indent \indent \indent \indent \indent \indent \indent \indent \indent \indent \indent \indent
$(\semBrcks{ \widehat{\pi} \vdash b : \boolexp}\widehat{C} \ \widehat{\eta} \ \sigma)$\\

mmm algo no esta bien con la ecuaci\'on anterior.\\
