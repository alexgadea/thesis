...
$(\lambda \sigma . \ \sigma \concat \sigmaover)_{\dbot}({head_{C}}_{\bot} ((\lambda v .$ \\
\indent \ \ 
	$\semBrcks{\pi,\iota:\deltavar \vdash c : \commt}(C \concat \lrangles{S_\delta})$\\
\indent \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
			$[ \ \semBrcks{\pi}(\hover,\sover)\eta \ | \ \iota:\lrangles{a,e} \ ]
...
\indent \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
 \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
		$(\semBrcks{\pi \vdash ei : \deltaexp}C\eta\sigma)))$ $=$\\
$(\lambda \sigma . \ \sigma \concat \sigmaover)_{\dbot}({head_{C}}_{\bot} ($ \\
\indent \ \ 
	$\semBrcks{\pi,\iota:\deltavar \vdash c : \commt}(C \concat \lrangles{S_\delta})$\\
\indent \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
			$[ \ \semBrcks{\pi}(\hover,\sover)\eta \ | \ \iota:\lrangles{a,e} \ ]
...
head_{C})_{\dbot} (\iotabot (\sigmatil \concat \lrangles{\tilde{v}}))$ $=$\\
$\sigmatil \concat \sigmaover$\\
...
$\shat \ f \ \sigma = (\lambda \sigma_{v} . \  
				...
				tail_{\lrangles{S_\delta}}\sigma_{v})_{\dbot} (f (\hhat \sigma))$\\
...
$(\lambda \sigma_{v} . \  
				...
				tail_{\lrangles{S_\delta}}\sigma_{v})_{\dbot}$ \\
\indent \ \ \ \ \ \ \ \
$(\semBrcks{\pi,\iota:\deltavar \vdash c : \commt}(C \concat \lrangles{S_\delta})$\\
\indent \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \
$[ \ \semBrcks{\pi}(\hover,\sover)\eta \ | \ \iota:\lrangles{a,e} \ ]) 
...
$(\lambda \sigma_{v} . \
				...
				tail_{\lrangles{S_\delta}}\sigma_{v}))_{\dbot}$
$(\iotabot (\sigmatil \concat \lrangles{\tilde{v}}))$ $=$\\
$head_{C'} (\sigmatil \concat \sigmaover \concat \lrangles{\tilde{v}})$ $=$
$\sigmatil \concat \sigmaover$\\
