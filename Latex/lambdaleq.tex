...
sem\'antica de derivaciones de un juicio de tipado para una frase con 
...
\ldots 
\circ \semBrcks{\theta_m \leq ~ \theta_{m-1}}$.
Pero prueba es directa de notar que 
...
hasta ac\'a hemos usado hip\'otesis inductiva en el juicio de tipado
$\pi \vdash e' : \thetahat \rightarrow \theta$ y la definici\'on de la 
ecuaci\'on sem\'antica
$\semBrcks{\thetahat' \rightarrow \theta' \leq \thetahat \rightarrow \theta}$\\
...
es importante notar que en la ultima igualdad hemos usado hip\'otesis inductiva, de 
hecho si ley\'eramos las igualdades de abajo para arriba quedar\'ia mas que claro y 
el caso a tener cuidado ser\'ia para el juicio $\pi \vdash e' : \thetahat \rightarrow \theta$\\
