...
un estar\'an las definiciones sint\'acticas, sem\'anticas y de tipos
...
Tanto para $\lambdaarrow$ como para $\lambdaleq$ esta sera $\Dom$, la cual es la
categor\'ia que tiene por objetos a dominios y por flechas a funciones continuas.
